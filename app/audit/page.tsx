...
import pageData from "@/content/pages/services/audit.json";
...
export default function AuditPage() {
  ...
  return (
    <>
      ...
      <JsonLd data={serviceSchema({ name: "Email marketing audit", description: pageData.meta.description, slug: "audit" })} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: site.url }, { name: "Email audit", url: `${site.url}/audit` }])} />
