...
import pageData from "@/content/pages/services/strategy.json";
...
export default function StrategyPage() {
  ...
  return (
    <>
      ...
      <JsonLd data={serviceSchema({ name: "Email strategy session", description: pageData.meta.description, slug: "strategy" })} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: site.url }, { name: "Email strategy", url: `${site.url}/strategy` }])} />
