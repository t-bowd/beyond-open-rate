...
Every dollar spent acquiring a customer is an investment. The return on that investment isn't a single transaction — it's the total revenue that customer generates over their lifetime.

Most ecommerce brands lose money on first orders once acquisition costs are factored in. You don't turn a profit until the second or third purchase. A **post-purchase email flow** is the most reliable mechanism for making that second purchase happen.

## Why post-purchase emails matter more than acquisition

Acquiring a new customer costs five to seven times more than retaining an existing one. Yet most brands spend 80% of their marketing budget chasing new buyers and let existing customers drift away.
