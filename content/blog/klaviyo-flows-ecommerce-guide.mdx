...
Your [**abandoned cart flow**](/blog/abandoned-cart-email-strategy) is typically the highest-revenue automation in Klaviyo. Average cart abandonment rate is 70%. Recovering even 10% of those carts is significant money.
...
If you're starting from scratch, build in this order: abandoned cart, welcome, post-purchase, abandoned browse, win-back. Cart abandonment has the shortest payback period. Australian brands that want this done correctly from the start often work with a [Klaviyo agency](/klaviyo-agency-australia) rather than building it themselves and iterating through mistakes.
...
If you've built all five flows, you're ahead of 80% of e-commerce brands. The next level is [segmentation](/blog/email-segmentation-strategies), splitting flows based on customer value, product category, or acquisition source.
