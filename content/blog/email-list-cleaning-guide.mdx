...
- [**Sender reputation**](/blog/email-authentication-guide) damage. ISPs (Gmail, Outlook, Yahoo) monitor engagement. Low engagement signals low relevance. Low relevance means the spam folder, even for engaged subscribers.
