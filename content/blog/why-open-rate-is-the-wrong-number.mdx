...
Open rate has been mostly noise since Apple shipped Mail Privacy Protection in 2021, which pre-fetches every tracking pixel on Apple Mail regardless of whether a human opened the email. For a decade it was the metric every marketer reported — easy to measure, easy to compare — and it was deeply, structurally misleading even before Apple made it worse.
...
2. The new scorecard is [revenue per recipient](/blog/email-marketing-roi), by send.
